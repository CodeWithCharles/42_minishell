FILES	=																	\
	...
	execution/execute_command execution/handle_fds minishell				\
	parsing/parse_commands pathing/get_cmd pathing/is_valid_builtin			\
	utils/env_utils utils/expand_variables utils/ft_free_split				\
	utils/ft_last_exit_code utils/ft_lstremove utils/ft_strreplace			\
